...
С помощью pg_dump было создано резервное копирование базы данных dbbainazarovei в файл backup.dump. Был использован параметр -Ft для создания файла в tar-архиве.
...
Было создано резервное копирование схемы test_schema и таблицы moderators из схемы public в формате t (tar-архив).
